...
public class JsonRepositoryTest {
    ...
    void setUp() {
        ...
        var u1 = new User(1, "FirstName1", "LastName1", "UserName1");
        var u2 = new User(2, "FirstName2", "LastName2", "UserName2");
        var u3 = new User(2, "FirstName3", "LastName3", "UserName3");

        users.add(u1);
        users.add(u2);
        users.add(u3);

        var t1 = new Task(1, "TaskTitle1", "TaskDescription1");
        var t2 = new Task(2, "TaskTitle2", "TaskDescription2");
        var t3 = new Task(3, "TaskTitle3", "TaskDescription3");
